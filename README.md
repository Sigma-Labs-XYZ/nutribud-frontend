...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/homepage.png?raw=true "Homepage")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/text-searchbar.png?raw=true "Text Searchbar")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/track-item-demo.gif "tracking item demo")

## Header

The header will be visible on every page of the website. If you're logged in, it will look something like this:

![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/header.png?raw=true "header image")

you can click on the little icon in the top right and a drop down menu will appear

![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/header-drop-down.png?raw=true "header drop down image")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/profile-page.png?raw=true "profile page picture")

You'll notice this ![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/info-icon.jpeg "info icon") icon in the top right of each component. Hovering over the icon will give you a run down of what that component means/does.

![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/info-hover-demo.gif "info icon hover demo")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/timeline-demo.gif "timeline demo")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/nutrient-overview-demo.gif "nutrient overview demo")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/settings-page-info.png "settings page, info tab")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/settings-page-goals.png "settings page, goals tab")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/create-acc-fail-demo.gif "creating an account fail")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/create-acc-success.gif "creating an account success")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/login-success.gif "logging in success")
...
![Image not found](https://github.com/Sigma-Labs-XYZ/nutribud-frontend/tree/main/readme-files/click-login-redirect.gif "login redirect")
